  ...
  function isActive(href: string) {
    ...
    if (href === "/admin/series") {
      return pathname === "/admin/series" ||
        (pathname.startsWith("/admin/series/") && !pathname.startsWith("/admin/series/compras"));
    }
      ...
      <aside className="relative overflow-hidden bg-gradient-to-b from-[#8f3a2e] via-[#9f4434] to-[#7f3227] text-white">
        <div className="relative flex h-full flex-col px-5 pb-6 pt-6">
          <div className="flex flex-col items-center">
            <div className="w-full max-w-[240px] rounded-[26px] bg-[#fff8f1] px-5 py-4 shadow-[0_12px_30px_rgba(0,0,0,.14)]">
              <Image
            ...
            <p className="mt-5 text-center text-[11px] font-black uppercase tracking-[.22em] text-[#f6e6d8]">
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center gap-3 rounded-[20px] px-4 py-3 transition-all ${
                    active
                      ? "bg-[#c8a089] text-white shadow-[0_12px_20px_rgba(0,0,0,.1)]"
